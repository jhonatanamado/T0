...
setInjectMinRun(tier0Config, 304830)

# Set the max run number - will be used to close the era
setInjectMaxRun(tier0Config, 304910)
...
defaultRecoTimeout =  48 * 3600 # we keep it 60h for XeXe Era.
...
# Multicore settings
# PR and Express to use 5 cores for XeXe jobs.
numberOfCores = 5
numberOfCoresExpress = 5
...
addExpressConfig(tier0Config, "Express",
                 ...
                 multicore = numberOfCoresExpress,
                 global_tag_connect = globalTagConnect,
